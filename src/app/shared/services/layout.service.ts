...
export class LayoutService {
  ...
  constructor(private themeService: ThemeService) {
    this.setAppLayout(
      //******** SET YOUR LAYOUT OPTIONS HERE *********
      {
        ...
        footerColor: "dark-gray", // http://demos.ui-lib.com/egret-doc/#egret-colors
  ...
  adjustLayout(options: IAdjustScreenOptions = {}, layout: any) {
    ...
    /* if (this.currentRoute) {
       this.fullWidthRoutes.forEach(route => {
         console.log('this.currentRoute.indexOf(route)', this.currentRoute.indexOf(route));

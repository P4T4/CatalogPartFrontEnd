...
export class NavigationService {
  ...
  constructor(private _configService: ConfigurationService) {
    this.userCurrent = _configService.GetCurrentUserMenuItem();
    console.log('userCurrent', this.userCurrent);
    var variable: Boolean;
    (this.userCurrent.typeUser == TypeUser.Admin) ? variable = false : variable = true;
    console.log('variable', variable);

  }
  iconMenu: IMenuItem[] = [
    this.userCurrent = this._configService.GetCurrentUserMenuItem(),
    {
      name: "Inicio",
      type: "link",
      tooltip: "Inicio",
    ...
    },
    {
      ...
      state: "marcas",
      sub: [
        { name: "Hyundai", state: "marca-hyundai" },
        { name: "Kia", state: "marca-kia" },
        { name: "Suzuki", state: "marca-suzuki" }
      ]
    },
    {
      name: "Garantía",
    ...
    /*{
      ...
      icon: "time_to_leave",
      state: "marcas",
      disabled: (this.userCurrent != " " && this.userCurrent.typeUser == TypeUser.Admin) ? false: true,
      sub: [
        { name: "Empresas", state: "marca-hyundai" },
        { name: "Usuarios", state: "marca-kia" }
      ]
    },
    {
      name: "Usuarios",
      ...
      icon: "contacts",
      state: "contactenos",
      disabled: (this.userCurrent != " " && this.userCurrent.typeUser == TypeUser.ClientAdminEnterprise) ? false: true
    },
    {
      name: "Creación",
      type: "dropDown",
      ...
      disabled: (this.userCurrent != " " && this.userCurrent.typeUser == TypeUser.Admin) ? false: true,
      sub: [
        { name: "Marca", state: "marca-hyundai" },
        { name: "Modelo", state: "marca-kia" },
        { name: "Producto", state: "marca-kia" }
      ]
    },
    */
    // {
    ...
    //   disabled: (this.userCurrent != " " && this.userCurrent.typeUser == TypeUser.ClientAdminEnterprise) ? false : true,
    //   sub: [
    //     { name: "Empresas", state: "enterprises" },
    //     { name: "Usuarios", state: "users" },
    //     { name: "Cupones", state: "cupons" }
    //   ]
    // },
    {
      name: "Usuarios",
    ...
    },
    {
      ...
      disabled: (this.userCurrent != " " && this.userCurrent.typeUser == TypeUser.Admin) ? false : true,
      sub: [
        { name: "Marca", state: "admin-marcas" },
        { name: "Referencia", state: "admin-references" },
        { name: "Producto", state: "admin-products" },
        {
          name: "Administrar",
          type: "dropDown",
          tooltip: "Marcas",
        ...
        { name: "Inventario", state: "admin-inventory" },
        { name: "Cupones", state: "cupons" },
        {
          name: "Reportes",
          type: "dropDown",
  ...
  publishNavigationChange(menuType: string) {
    switch (menuType) {
      ...
      case "icon-menu":
        ...
        console.log('this.iconMenu', this.iconMenu);
        break;
      default:

...
export class AdminLayoutComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    .subscribe((routeChange: NavigationEnd) => {
      this.layout.adjustLayout({ route: routeChange.url }, this.layoutConf.sidebarStyle);
      this.scrollToTop();
    });
  ...
  onResize(event) {
    //console.log('onrezise');
    this.layout.adjustLayout(event, this.layoutConf.sidebarStyle);
  }
  ...
  updateAdminContainerClasses(layoutConf) {
    //console.log('updateAdminContainerClasses', layoutConf.sidebarStyle);
    return {
